...
analysis_type = st.sidebar.selectbox(
    "📈 Analysis Type",
    ["Overview", "RFM Segmentation", "Behavioral Clustering", "Conversion Analysis", "Business Insights"]
)
...
if analysis_type == "Overview":
    ...
    fig_event = px.bar(x=event_counts.index, y=event_counts.values, title="Events by Type")
...
st.markdown(
    ...
    <div style='text-align: center; color: #666;'>
        <p>📊 Advanced E-commerce Analytics Dashboard | Week 2 Features</p>
